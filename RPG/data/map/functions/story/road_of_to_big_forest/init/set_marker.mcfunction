...
kill @e[tag=Boss.RoadOfToBigForest.1]
data merge storage map:story {Tags:["Boss.RoadOfToBigForest.1","Boss.Marker","Story"]}
execute positioned 28.5 11 -692.5 summon item_display run function map:story/_marker/boss